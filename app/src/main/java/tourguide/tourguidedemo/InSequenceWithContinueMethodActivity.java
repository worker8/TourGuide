        ...
        TourGuide mTG1 = TourGuide.init(this)
                ...
                .setOverlay(new Overlay().setEnterAnimation(enterAnimation).setExitAnimation(exitAnimation).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(InSequenceWithContinueMethodActivity.this, "Hihi! Nice to meet you", Toast.LENGTH_SHORT).show();
        ...
        Sequence seq = new Sequence.SequenceBuilder()
                             ...
                             .setDefaultOverlay(new Overlay()
                                     ...
                                     .setOnClickListener(new View.OnClickListener() {
                                         @Override
                                         public void onClick(View v) {
                                             Toast.makeText(InSequenceWithContinueMethodActivity.this, "Hihi! This is the default Overlay", Toast.LENGTH_SHORT).show();
                                             mTutorialHandler.next();
                                         }
                                     }))
                             .setDefaultToolTip(new ToolTip()
                                     ...
                                     .setOnClickListener(new View.OnClickListener() {
                                         @Override
                                         public void onClick(View v) {
                                             Toast.makeText(InSequenceWithContinueMethodActivity.this, "Bello! This is the default Tooltip!", Toast.LENGTH_SHORT).show();
                                         }
                                     }))
                             .setDefaultPointer(new Pointer())
                             .setDisableButton(true)
                             //To set the continue method, it means it will
                             .setContinueMethod(ContinueMethod.ToolTip | ContinueMethod.Overlay)
                             .build();
